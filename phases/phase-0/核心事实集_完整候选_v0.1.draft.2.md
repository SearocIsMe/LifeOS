# 核心事实集 完整候选（50 条）v0.1.0-draft.2

本文件与 `核心事实集_完整候选_v0.1.draft.2.yaml` 内容完全一致，供预览；管线以 .yaml 为准。

**性质**：AI 候选全集（未人工编写、未互审、未签署、未注册）；全部条目完成合并和审查。
...
- fact_id: CF-001
  ...
  content: 用户在日常交流中的称呼是小岚。
  qa_probe:
  - 这位使用者平时怎么称呼？
  privacy_level: normal
  importance: 5
  notes: 原创虚构；AI候选（未人工编写、未互审、未签署）；content删元叙述「虚构用户」；完成合并和审查。
- fact_id: CF-002
  category: identity_core
  type: semantic
  subject_id: user
  ...
  privacy_level: normal
  importance: 5
  notes: 原创虚构；AI候选（未人工编写、未互审、未签署）；复审无实质改动；完成合并和审查。
- fact_id: CF-003
  category: identity_core
  type: semantic
  subject_id: user
  ...
  privacy_level: normal
  importance: 5
  notes: 原创虚构；AI候选（未人工编写、未互审、未签署）；content删元叙述「虚构」；完成合并和审查。
- fact_id: CF-004
  category: identity_core
  type: semantic
  subject_id: user
...
- fact_id: CF-006
  ...
  privacy_level: normal
  importance: 5
  notes: 原创虚构；AI候选（未人工编写、未互审、未签署）；probe改从习得视角提问，去「母语」关键词复用；完成合并和审查。
- fact_id: CF-007
  category: identity_core
  type: semantic
  subject_id: user
...
- fact_id: CF-008
  ...
  privacy_level: normal
  importance: 5
  notes: 原创虚构；AI候选（未人工编写、未互审、未签署）；probe「自己」改「本人」拆解四字组重合；完成合并和审查。
- fact_id: CF-009
  category: biography
  type: episodic
  subject_id: user
  ...
  importance: 3
  notes: 原创虚构；AI候选（未人工编写、未互审、未签署）；probe日期锚点改阿拉伯数字写法；完成合并和审查。
- fact_id: CF-010
  category: biography
  type: episodic
  subject_id: user
  ...
  privacy_level: personal
  importance: 3
  notes: 原创虚构；AI候选（未人工编写、未互审、未签署）；probe日期锚点改阿拉伯数字写法（原重合率0.50踩线）；完成合并和审查。
- fact_id: CF-011
  category: biography
  type: episodic
  subject_id: user
...
- fact_id: CF-033
  ...
  slot_key: person.connection
  content: 小岚与同事阿禾曾合作完成展厅照明项目。
  qa_probe:
  - 小岚和阿禾合作的是哪项任务？
  privacy_level: personal
  importance: 4
  notes: 原创虚构；AI候选（未人工编写、未互审、未签署）；进行态改过去完成态以稳定化（红线5），按用户指示采稳定表述；完成合并和审查。
- fact_id: CF-034
  category: relationship
  type: semantic
...
review:
  ...
  notes: AI原创候选（草稿v0.1.0-draft.1经整库review与修订后的合并版）；未独立互审；无签署；不得据此宣称AC-09或任何Gate通过；已接受全集不存在，全部条目完成合并和审查。
```
